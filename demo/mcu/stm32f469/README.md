...
3. Copy the contents of the `.h` header file and update the `DEFAULT_KEYWORD_ARRAY` value in [/stm32f469i-disco/Inc/pv_params.h](./stm32f469i-disco/Inc/pv_params.h)
