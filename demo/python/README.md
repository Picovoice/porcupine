...
```bash
python demo/python/porcupine_demo.py --keyword_file_path resources/keyword_files/blueberry_${SYSTEM}.ppn
``` 
...
```bash
python demo/python/porcupine_demo.py --keyword_file_path resources/keyword_files/blueberry_linux.ppn \
