...
This npm package is for Node.js and **does not work in a browser**. Looking to run Porcupine in-browser? There are npm packages available for [Web](https://www.npmjs.com/package/@picovoice/porcupine-web), and dedicated packages for [React](https://www.npmjs.com/package/@picovoice/porcupine-react), and [Vue](https://www.npmjs.com/package/@picovoice/porcupine-vue).
